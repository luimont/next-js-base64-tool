...
export const TextArea = ({...props}) => {
  const {textAreaInput, isDecode, handleTextAreaChange, handleSwitchMode, isResultTextArea} = props
  return (
    <div className="my-2" >      
      <form>
        <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
            <div className="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
                ...
                <textarea id="comment" rows={4} className="w-full min-h-40 px-0 text-sm text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write a text..." required value={textAreaInput} onChange={handleTextAreaChange} />
            </div>
                {
                  !isResultTextArea 
                  ? 
                  ...
                  : 
                  <div className="flex items-center justify-between px-3 py-2 border-t dark:border-gray-600">
                    <button type="submit" className="inline-flex items-center py-2.5 px-4 text-s font-medium text-center text-white bg-gray-500 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-gray-400">                      
                      Copy
                    </button>
                  </div>
                }
